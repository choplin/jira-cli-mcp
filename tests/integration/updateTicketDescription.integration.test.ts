...
describe.skipIf(!shouldRunIntegrationTests)("updateTicketDescription integration tests", () => {
  test.skipIf(!process.env.JIRA_CLI_MCP_TEST_TICKET)("should update ticket description with real jira-cli", async () => {
