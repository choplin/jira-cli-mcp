...
describe.skipIf(!shouldRunIntegrationTests)("moveTicket integration tests", () => {
  test.skipIf(!process.env.JIRA_CLI_MCP_TEST_TICKET)("should move ticket status with real jira-cli", async () => {
